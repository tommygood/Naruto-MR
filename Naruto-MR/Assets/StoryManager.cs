...
namespace LinesNamespace
{
    ...
    public class LinesManager
    {
        ...
        public List<string> subtitles = new List<string> {
            "結印是釋放忍術必要的技巧，包含結印的正確性和速度，\n往往都決定了一個忍者的好壞。佐助，對你來說這算是非常簡單的吧！",
            "當然，我可是班上成績最好的。",
            "那你就試試看依序使用不同忍術，擊倒這些靶子吧，\n如果你忘記怎麼做，可以看一下那邊的秘笈。",
            "佐助！！！你想要逃跑嗎",
            "呦，你這個吊車尾的，這次又換你了嗎，\n小櫻已經跟我說過了，你們不要再管我了",
            "為什麼，為什麼你會變成這個樣子呢",
            "我會變成什麼樣子，關你什麼事呢。\n老實說吧，我已經不想和你們木葉的人在一起了，回去吧",
            "大家都是拼上性命，要來把你帶回去的...",
            "真是辛苦你們了，可以回去了",
            "你這傢伙，把我們夥伴當作什麼了！！！",
            "什麼夥伴，呵，夥伴能夠幫助我變強嗎？\n總之，我要去大蛇丸那邊",
            "你以為大蛇丸會無條件地幫你嗎？\n我們怎麼可能讓你去送死呢",
            "那種事情我才不在乎，只要可以達成我的目標，\n要怎樣都無所謂，如果你堅持要阻止我，那就沒辦法了",
            "你小子，即使使用蠻力，\n我也要把你帶回去！",
            "這次我們一定要做個了斷，我要打敗你",
            "我一定要把你帶回去",
            "你也差不多該清醒過來了吧！",
